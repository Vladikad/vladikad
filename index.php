...
<html lang="en-US">
<head>
<title>Информационная панель для мод состава</title>
<meta charset="utf-8">
...
<div class="page-con-content landing-con-override">
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Pixelmon 1.12.2<br>
							 Справочник мод.состава</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 Создан для помощи младшему мод составу
							</p>
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/pix.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="">
		...
		<div class="content-con-outside">
			<div class="" href="#myCarousel" data-slide="prev">
			</div>
			<div class="" href="#myCarousel" data-slide="next">
			</div>
			<div class="">
			</div>
		</div>
	...
	<div class="">
		...
		<div class="">
			<div class="">
				...
				<ins class="" data-ad-client="ca-pub-9076246674760451" data-ad-slot="1835527222"></ins>
				<script>
			...
			<div class="">
				<div class="">
					...
					<div class="">
						<div class="">
							<div class="">
								<div class="" style="background: #9647c7">
								</div>
							</div>
							<div class="">
	...
	<div class="">
		...
		<div class="">
			<div class="adsense-con-frame">
				...
				<ins class="" data-ad-client="" data-ad-slot=""></ins>
				<script>
						(adsbygoogle = window.adsbygoogle || []).push({});
				</script>
			</div>
			...
			<div class="">
				<div class="">
					...
					<div class="">
						<div class="">
							<div class="">
								<div class="" style="background: #ff424d">
								</div>
							</div>
							<div class="">
							</div>
