...
<div class='menu-con-container'>
	...
	<div class="menu-con-outer">
		<div class="menu-con-inner">
			...
			<a href='https://mcskill.net/mcforum/' target="_blank">
			<div class="menu-btn-select">
				<span>Форум</span>
			</div>
			</a>
			<a href='https://www.youtube.com/@McSkillnet./videos' target="_blank">
			<div class="menu-btn-select">
				<span>YouTube</span>
			</div>
			</a>
			<a href='https://ru.pixelmon.site/'>
			<div class="menu-btn-select">
				<span>Вики</span>
			</div>
			</a>
			<a href='https://discord.com/invite/6kRFkr8B?utm_source=Discord%20Widget&utm_medium=Connect' target="_blank">
			<div class="menu-btn-select">
				<span>Discord</span>
			</div>
			</a>
